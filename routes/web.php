...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:customer'])->group(function () {
        ...
        // Payments (FIXED)
        // Perhatikan nama route menjadi 'payment.checkout' (singular)
        Route::get('/checkout/{collection}', [PaymentController::class, 'checkout'])->name('payment.checkout');
    ...
    Route::middleware(['role:admin,provider'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/collections/{collection}/verify-payment', [AdminCollectionController::class, 'verifyPayment'])
            ->name('collections.verify_payment');
...
// --- ROUTE CALLBACK HARUS DILUAR GROUP AUTH ---
